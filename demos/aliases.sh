...
alias yqc="yq r -C"
alias tree="tree -C"
alias cicd1="source demorunner.sh \$ADMIN/demos/1-building-images/demo.txt"
alias cicd2="source demorunner.sh \$ADMIN/demos/2-configuration-customization/demo.txt"
alias cicd3="source demorunner.sh \$ADMIN/demos/3-gitops/demo.txt"
alias cicd4="source demorunner.sh \$ADMIN/demos/4-continuous-operations/demo.txt"
alias cicd5="source demorunner.sh \$ADMIN/demos/5-kpack/demo.txt"
alias cicd6="source demorunner.sh \$ADMIN/demos/6-workflow-automation/demo.txt"
alias cicd7="source demorunner.sh \$ADMIN/demos/7-jenkinsx/demo.txt"
